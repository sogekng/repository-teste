...
function mudarContentSobre(){
  ...
  document.querySelector('.content-1 h1').style.color = '#2e3033';
  document.querySelector('.content-1 span').style.color = '#2e3033';
  document.querySelector('.content-2 h1').style.color = 'rgba(255, 255, 255, .9)';
  document.querySelector('.content-2 span').style.color = 'rgba(255, 255, 255, .9)';
  document.getElementById('content-sobre').style.display = 'flex';
  document.getElementById('content-contato').style.display = 'none';
  ...
  document.getElementById('container-button-top1').style.background = 'linear-gradient(180deg, #2e3033, #2e3033dc, #2e3033bb,transparent)';
  document.getElementById('container-button-top2').style.background = 'linear-gradient(180deg, #2e3033, #2e3033dc, #2e3033bb,transparent)';
  document.getElementById('container-button-top3').style.background = 'linear-gradient(180deg, #2e3033, #2e3033dc, #2e3033bb,transparent)';
  document.getElementById('container-button-top4').style.background = 'linear-gradient(180deg, #2e3033, #2e3033dc, #2e3033bb,transparent)';
  document.getElementById('container-button-top5').style.background = 'linear-gradient(180deg, #2e3033, #2e3033dc, #2e3033bb,transparent)';
  document.getElementById('container-button-top6').style.background = 'linear-gradient(180deg, #2e3033, #2e3033dc, #2e3033bb,transparent)';
  document.getElementById('container-button-top7').style.background = 'linear-gradient(180deg, #2e3033, #2e3033dc, #2e3033bb,transparent)';
...
function mudarContentContato(){
  ...
  document.getElementById('content-contato').style.display = 'flex';
  document.getElementById('content-sobre').style.display = 'none';
  document.querySelector('.content-1 h1').style.color = 'rgba(255, 255, 255, .9)';
  document.querySelector('.content-1 span').style.color = 'rgba(255, 255, 255, .9)';
  document.querySelector('.content-2 h1').style.color = 'rgb(249, 205, 72)';
  document.querySelector('.content-2 span').style.color = 'rgb(249, 205, 72)';
  ...
  document.getElementById('container-button-top1').style.background = 'linear-gradient(180deg, rgb(249, 205, 72),transparent)';
  document.getElementById('container-button-top2').style.background = 'linear-gradient(180deg, rgb(249, 205, 72),transparent)';
  document.getElementById('container-button-top3').style.background = 'linear-gradient(180deg, rgb(249, 205, 72),transparent)';
  document.getElementById('container-button-top4').style.background = 'linear-gradient(180deg, rgb(249, 205, 72),transparent)';
  document.getElementById('container-button-top5').style.background = 'linear-gradient(180deg, rgb(249, 205, 72),transparent)';
  document.getElementById('container-button-top6').style.background = 'linear-gradient(180deg, rgb(249, 205, 72),transparent)';
  document.getElementById('container-button-top7').style.background = 'linear-gradient(180deg, rgb(249, 205, 72),transparent)';
